...
public class Evaluacion extends Observable {
    ...
    public Double typePercentageMC(){
        ...
        Double percentageMC = (double) (100*(correctCountMC / totalCountMC));
        return percentageMC;
    }
    ...
    public float typePercentageTF(){
        ...
        return (float) (100 * (correctCountTF/totalCountTF));
    }
    ...
    public float recordarPercentage(){
        ...
        return (float) (100 * (correctCountR/totalCountR));
    }
    ...
    public float entenderPercentage() {
        ...
        return (float) (100 * (correctCountEntender/totalCountEntender));
    }
    ...
    public float aplicarPercentage() {
        ...
        return (float) (100 * (correctCountAplicar/totalCountAplicar));
    }
    ...
    public float analizarPercentage() {
        ...
        return (float) (100 * (correctCountAnalizar/totalCountAnalizar));
    }
    ...
    public float evaluarPercentage() {
        ...
        return (float) (100 * (correctCountEvaluar/totalCountEvaluar));
    }
    ...
    public float crearPercentage() {
        ...
        return (float) (100 * (correctCountCrear/totalCountCrear));
    }
}